...
<div id="main">
        <form name=alipayment action="/wap/pay.do" method=post target="_blank">
...
：</dt>
					<dd>
						<input name="WIDshow_url" id="WIDshow_url" value="http://www.baidu.com"/>
					</dd>
                    			<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input name="WIDbody" id="WIDbody" value="iphone-700"/>
					</dd>
                    			<hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
...
<script language="javascript">
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "test-info";
