(function(b) {
  ...
  var b = function(c) {
    ...
    this.options.wysiwyg = a.extend({},
    b.defaults.wysiwyg, c.wysiwyg)
  };
  ...
  a.extend(b.prototype, {
    render: function() {
      ...
      }).prev().addClass("wysiwyg-style2").closest(".editable-input").addClass("editable-wysiwyg").closest(".editable-container").css({
        display: "block"
      });
