...
public class MQOrderlyProducer {
    private Logger logger = LoggerFactory.getLogger(MQOrderlyProducer.class);
...
//        必须设为false否则连接broker10909端口
    ...
    public String sendMsg(String body, String tag, Integer orderId) throws UnsupportedEncodingException, InterruptedException, RemotingException, MQClientException, MQBrokerException {
